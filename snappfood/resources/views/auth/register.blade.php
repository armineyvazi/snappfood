                ...
                <div class="flex justify-center">
                    <div class="mb-3 xl:w-96">
                      <select class="block mt-1 w-full" required name="select">
                        <option value='0'>Select for user or Resturant owner default is user</option>
                        <option value="1">Resturant Owner</option>
