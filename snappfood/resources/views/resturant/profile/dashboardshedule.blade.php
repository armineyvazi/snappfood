...
<form method="POST" action="{{ route('shedules.store') }}">
    @csrf
        <div class="grid xl:grid-cols-2 xl:gap-6 mt-5">
            <div class="relative z-0 w-full mb-6 group">
            <input value="" type="time" name="sat-s" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
         ...
         <div class="relative z-0 w-full mb-6 group">
                <input value="" type="time" name="sat-e" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
        ...
        <div class="grid xl:grid-cols-2 xl:gap-6 mt-5">
            <div class="relative z-0 w-full mb-6 group">
                <input value="" type="time" name="sun-s" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
        ...
        <div class="relative z-0 w-full mb-6 group">
                <input value="" type="time" name="sun-e" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
        ...
        <div class="grid xl:grid-cols-2 xl:gap-6 mt-5">
            <div class="relative z-0 w-full mb-6 group">
                <input value="" type="time" name="mon-s" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
        ...
        <div class="relative z-0 w-full mb-6 group">
                    <input value="" type="time" name="mon-e" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
        ...
        <div class="grid xl:grid-cols-2 xl:gap-6 mt-5">
            <div class="relative z-0 w-full mb-6 group">
                <input value="" type="time" name="tue-s" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
            ...
            <div class="relative z-0 w-full mb-6 group">
                    <input value="" type="time" name="tue-e" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6 mt-5">
                <div class="relative z-0 w-full mb-6 group">
                    <input value="" type="time" name="wed-s" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
                ...
                <div class="relative z-0 w-full mb-6 group">
                        <input value="" type="time" name="wed-e" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
                ...
                <div class="grid xl:grid-cols-2 xl:gap-6 mt-5">
                    <div class="relative z-0 w-full mb-6 group">
                        <input value="" type="time" name="thu-s" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input value="" type="time" name="thu-e" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
                ...
                <div class="grid xl:grid-cols-2 xl:gap-6 mt-5">
                    <div class="relative z-0 w-full mb-6 group">
                        <input value="" type="time" name="fri-s" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input value="" type="time" name="fri-e" id="send_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " >
